$(document).ready(function() {
    function checkWidth() {
      ...
      if (windowWidth <= 600 && windowHeight >= 600) {
          ...
          $('.letter').css('background-image', 'url(images/alphabet-77.svg')
          $('.word').css('background-image', 'none')
      }

      else if (windowWidth <= 675 && windowHeight >= 600) {
          $('.letter').css('background-image', 'url(images/alphabet-76.svg')
          $('.word').css('background-image', 'none')
      }

      else if (windowWidth <= 700 && windowHeight >= 600) {
          $('.letter').css('background-image', 'url(images/alphabet-75.svg')
          $('.word').css('background-image', 'none')
      }

      else if (windowWidth <= 725 && windowHeight >= 600) {
          $('.letter').css('background-image', 'url(images/alphabet-74.svg')
          $('.word').css('background-image', 'none')
      }

      else if (windowWidth <= 750 && windowHeight >= 600) {
          $('.letter').css('background-image', 'url(images/alphabet-73.svg')
          $('.word').css('background-image', 'none')
      }

      else if (windowWidth <= 775 && windowHeight >= 600) {
          $('.letter').css('background-image', 'url(images/alphabet-72.svg')
          $('.word').css('background-image', 'none')
      }

      else if (windowWidth <= 800 && windowHeight >= 600) {
          $('.letter').css('background-image', 'url(images/alphabet-71.svg')
          $('.word').css('background-image', 'none')
      }

      else if (windowWidth <= 825 && windowHeight >= 600) {
          $('.letter').css('background-image', 'url(images/alphabet-70.svg')
          $('.word').css('background-image', 'none')
      }

      else if (windowWidth <= 850 && windowHeight >= 600) {
          $('.letter').css('background-image', 'url(images/alphabet-69.svg')
          $('.word').css('background-image', 'none')
      }

      else if (windowWidth <= 875 && windowHeight >= 600) {
          $('.letter').css('background-image', 'url(images/alphabet-68.svg')
          $('.word').css('background-image', 'none')
      }

      else if (windowWidth <= 900 && windowHeight >= 600) {
          $('.letter').css('background-image', 'url(images/alphabet-67.svg')
          $('.word').css('background-image', 'none')
      }

      else if (windowWidth <= 925 && windowHeight >= 600) {
          $('.letter').css('background-image', 'url(images/alphabet-66.svg')
          $('.word').css('background-image', 'none')
      }

      else if (windowWidth <= 950 && windowHeight >= 600) {
          $('.letter').css('background-image', 'url(images/alphabet-65.svg')
          $('.word').css('background-image', 'none')
      }

      else if (windowWidth <= 975 && windowHeight >= 600) {
          $('.letter').css('background-image', 'url(images/alphabet-64.svg')
          $('.word').css('background-image', 'none')
      }

      else if (windowWidth <= 1000 && windowHeight >= 600) {
          $('.letter').css('background-image', 'url(images/alphabet-63.svg')
          $('.word').css('background-image', 'none')
      }

      else if (windowWidth <= 1025 && windowHeight >= 600) {
          $('.letter').css('background-image', 'url(images/alphabet-62.svg')
          $('.word').css('background-image', 'none')
      }
    ...
    $('.color-change').click(function() {
      ...
      $('.letter').toggleClass('invert')
      $('.word').toggleClass('invert')
      $('.font').toggleClass('white-t')
      $('.designer').toggleClass('white-t')
      $('.foundry').toggleClass('white-t')
      $('.year').toggleClass('white-t')
    })
